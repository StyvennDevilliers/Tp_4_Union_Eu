...
public class Ihm {
    public static void main(String[] args) {
        ...
        switch (menu) {
            case 1:
                Outils.affichageNom(menu, pays);
                break;
            case 2:
                Outils.affichageCapitale(menu,pays);
                break;
            case 3:
                Outils.affichageNombreHabitant(menu,pays);
                break;
            case 4:
                Outils.affichageSuperficie(menu,pays);
                break;
            case 5:
                Outils.affichageDensite(menu,pays);
                break;
            case 6,7:
    ...
    public static void pays(Pays [] pays) {
        ...
        pays[2] = new Pays(45336,1374687,"Tallin","Estonie",2004);
        pays[9] = new Pays(338363,5603851,"Helsinki","Finlande",1995);
        pays[19] = new Pays(638475,68401997,"Paris","France",1958);
        ...
        pays[10] = new Pays(64594,1871882,"Riga","Lettonie",2004);
        ...
        pays[15] = new Pays(37391,17942942,"Amsterdam","Pays-Bas",1958);
